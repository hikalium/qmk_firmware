...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox(KC_EQUAL,KC_1,KC_2,KC_3,KC_4,KC_5,KC_LEFT,KC_BSLASH,KC_Q,KC_W,KC_E,KC_R,KC_T,MO(2),KC_LCTRL,KC_A,KC_S,KC_D,KC_F,KC_G,KC_LSHIFT,KC_Z,KC_X,KC_C,KC_V,KC_B,KC_LANG2,MO(1),KC_LALT,KC_TRANSPARENT,KC_LEFT,KC_RIGHT,KC_ESCAPE,KC_LGUI,MO(1),KC_SPACE,KC_BSPACE,LCTL(KC_B),KC_RIGHT,KC_6,KC_7,KC_8,KC_9,KC_0,KC_MINUS,MO(2),KC_Y,KC_U,KC_I,KC_O,KC_P,KC_QUOTE,KC_H,KC_J,KC_K,KC_L,KC_SCOLON,KC_RCTRL,KC_LANG1,KC_N,KC_M,KC_COMMA,KC_DOT,KC_SLASH,KC_RSHIFT,KC_UP,KC_DOWN,KC_TRANSPARENT,KC_RALT,MO(1),KC_LALT,KC_COLN,MO(1),RCTL(KC_B),KC_TAB,KC_ENTER),
